...
import { createRouter, createWebHistory } from 'vue-router';
 ...
 function setDomain() {
  ...
  window.ORIGIN = process.env.NODE_ENV === 'development' ? process.env.VITE_ORIGIN_DEV : process.env.VITE_ORIGIN_PRO;
...
function render(props = {}) {
  ...
  history = createWebHistory(qiankunWindow.__POWERED_BY_QIANKUN__ ? '/field-system' : '/');
